                                ...
                                <div class="container">
                                    <div class="row">
                                        <div class="col-lg-5 my-2">
                                            <img src="./assets/img/tofbg.png" alt="" class="img-fluid">
                                            <h3>Tower of Fantasy</h3>
                                            <p class="pe-5">Mulai petualangan fantasi bersama! <br>
                                                Dengan latar cerita ratusan tahun di masa depan di planet Aida yang jauh,
                                                Tower of Fantasy, game petualangan sci-fi dengan sentuhan anime bergaya
                                                MMORPG dunia terbuka bersama yang dikembangkan oleh Hotta Studio dan diterbitkan
                                                oleh Level Infinite, akan hadir di PC dan platform mobile secara global pada tahun 2022.
                                                Pemain bisa merasakan dunia sci-fi pascaapokaliptik yang terinspirasi dari anime,
                                                modifikasi bebas model karakter, objektif menarik, dan pertarungan seru dan mendebarkan serta
                                                eksplorasi dunia terbuka yang seru.
                                            </p>
                                            <a href="https://www.toweroffantasy-global.com/" class="btn btn-link"> -> Baca Lebih Lanjut <- </a>
                                        </div>
                                        <div class="col-lg-7 mt-lg-0 mt-5 ps-lg-0 ps-0">
                                            <div class=" row">
                                                <form action="proses_tof.php" method="POST">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-6 my-auto">
                                                                <div class="form-group">
                                                                    <select name="server" class="form-select bg-white m-1" required="">
                                                                ...
                                                                while ($data = mysqli_fetch_array($query)) { ?>
                                                                    <label class="custom-radio">
                                                                        ...
                                                                        <span class="radio-btn"><img src="<?php echo $data['icon'] ?>" alt="">
                                                                            <p class="text-icon"><?php echo $data['nama'] ?> <br> Rp.<?php echo $data['harga'] ?></p>
                                                                        </span>
                                                                    </label>
                                                                <?php } ?>
                                                    ...
                                                    <input type="text" class="form-control" name="game" value="Tower Of Fantasy" hidden>
                                                    <div class="m-2">
