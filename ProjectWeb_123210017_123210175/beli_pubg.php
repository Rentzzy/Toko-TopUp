                                ...
                                <div class="container">
                                    <div class="row">
                                        <div class="col-lg-5 my-2">
                                            <img src="./assets/img/pubgbg.png" alt="" class="img-fluid">
                                            <h2 class="text-white text-black-50">PUBG Mobile</h2>
                                            <p class="pe-5">
                                                Masterpiece battle royale yang dahsyat
                                                Beragam event untuk kamu jelajahi
                                                Raih posisi puncak di PUBG MOBILE dan tembak di sasaran. PUBG MOBILE adalah game seluler battle royale orisinal dan salah satu game menembak seluler terbaik.
                                                Pertempuran ekstrem dalam pertandingan 10 menit
                                                Persiapkan senjatamu, penuhi panggilan tempur di PUBG MOBILE dan tembak di sasaran.
                                                Beragam peta dan mode
                                                PUBG MOBILE memiliki banyak peta dan mekanisme gameplay yang menyajikan pengalaman bertahan hidup menegangkan. Temukan temanmu dan mainkan mode baru bersama-sama! Bermain sesuka hati dan tembak di sasaran!
                                            </p>
                                            <a href="https://playvalorant.com/id-id/" class="btn btn-link"> -> Baca Lebih Lanjut <- </a>
                                        </div>
                                        <div class="col-lg-7 mt-lg-0 mt-5 ps-lg-0 ps-0">
                                            <div class=" row">
                                                <form action="proses_pubg.php" method="POST">
                                                    <div class="card-body bg-white blur-rounded border-radius-xl top-0 z-index-fixed m-2">
                                                        <h5>1. Masukkan ID Player</h5>
                                                        <div class="row">
                                                            <div class="col-md-6 my-auto">
                                                                <div class="input-group input-group-outline my-3">
                                                                    <label class="form-label">ID Player</label>
                                            ...
                                            <input type="text" class="form-control" name="game" value="PUBGM" hidden>
                                            <div class="m-2">
