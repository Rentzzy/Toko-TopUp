                                ...
                                <div class="container">
                                    <div class="row">
                                        <div class="col-lg-5 my-2">
                                            <img src="./assets/img/apexbg.jpg" alt="" class="img-fluid">
                                            <h3>Apex Leagends Mobile</h3>
                                            <p class="pe-5">Berada dalam dunia Apex Legends™ yang imersif, Apex Legends Mobile adalah game shooter Battle Royale strategis yang menampilkan gameplay berbasis karakter legendaris, pertarungan pasukan terbaik di kelasnya, dan pertarungan cepat yang mengukuhkan posisi game sebagai salah satu shooter teratas, semuanya di dalam ponsel.
                                                <br> Gameplay multipemain memungkinkan pemain untuk bergabung dengan dua teman dan bersaing dengan pemain seluler lainnya. Gabungkan keterampilan unik setiap Legend untuk menguasai peran kelompok, mensinergikan permainan, dan mendominasi Permainan Apex Legends.
                                            </p>
                                            <a href="https://www.ea.com/games/apex-legends/apex-legends-mobile" class="btn btn-link"> -> Baca Lebih Lanjut <- </a>
                                        </div>
                                        <div class="col-lg-7 mt-lg-0 mt-5 ps-lg-0 ps-0">
                                            <div class=" row">
                                                <form action="proses_apex.php" method="POST">
                                                    <div class="card-body bg-white blur-rounded border-radius-xl top-0 z-index-fixed m-2">
                                                        <h5>1. Masukkan ID Apex Leagends Mobile</h5>
                                                        <div class="row">
                                                            <div class="col-md-6 my-auto">
                                                                <div class="input-group input-group-outline my-3">
                                                                    <label class="form-label">ID Apex Leagends Mobile</label>
                                            ...
                                            <input type="text" class="form-control" name="game" value="Apex Leagends Mobile" hidden>
                                            <div class="m-2">
