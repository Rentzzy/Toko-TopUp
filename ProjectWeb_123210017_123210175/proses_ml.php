						...
						<div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
							<div class="bg-me shadow-primary border-radius-lg py-3 pe-1">
								...
								<div align="center" class="text-white">
									...
									$game = $_POST['game'];
									$query = mysqli_query($connect, "SELECT * FROM mlbb where id=$id");
						...
						<div class="card-body">
							<form action="detail.php" method="POST">
								...
								<div class="mb-2 row input-group input-group-outline">
									<label for="inputID" class="col-sm-3 col-form-label">User ID :</label>
									<div class="col-sm-8">
										<input type="text" class=" form-control" name="user_id" value="<?php echo $user_id; ?>" readonly>
									</div>
								</div>
								<div class="mb-2 row input-group input-group-outline">
									<label for="inputID" class="col-sm-3 col-form-label">Zone ID :</label>
									<div class="col-sm-8">
