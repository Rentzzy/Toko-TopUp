                ...
                <div class="container">
                  <div class="row">
                    <div class="col-lg-5 my-2">
                      <img src="./assets/img/gensinbg.jpg" alt="" class="img-fluid">
                      <h3>Genshin Impact</h3>
                      <p class="pe-5">Genshin Impact adalah game RPG Open World terbaru. Kamu adalah seorang pengembara yang menjelajah sebuah dunia fantasi yang teramat luas, kamu dapat menjelajahi tujuh bangsa, bertemu berbagai karakter berkemampuan dan berkepribadian unik, melawan musuh-musuh kuat, dan berkelana mencari saudaramu yang hilang. Di dunia yang luas ini, biarkan rasa keingintahuan membawamu menguak misteri-misteri yang tersembunyi, sampai akhirnya kamu dapat bertemu kembali dengan saudaramu, dan menyaksikan akhir dari kisah perjalananmu.</p>
                      <a href="https://genshin.hoyoverse.com/en/" class="btn btn-link"> -> Baca Lebih Lanjut <- </a>
                    </div>
                    <div class="col-lg-7 mt-lg-0 mt-5 ps-lg-0 ps-0">
                      <div class=" row">
                        <form action="proses_gi.php" method="POST">
                                ...
                                while ($data = mysqli_fetch_array($query)) { ?>
                                  <label class="custom-radio">
                                    ...
                                    <span class="radio-btn"><img src="<?php echo $data['icon'] ?>" alt="">
                                      <p class="text-icon"><?php echo wordwrap($data['nama'], 9, "<br>\n")  ?>
                                        <br> Rp.<?php echo number_format($data['harga'], 2, ",", ".") ?>
                                      </p>
                                    </span>
                                  </label>
                                <?php } ?>
                          ...
                          <input type="text" class="form-control" name="game" value="Genshin Impact" hidden>
                          <div class="m-2">
