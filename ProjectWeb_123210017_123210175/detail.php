					...
					<div class="card z-index-0 fadeIn3 fadeInBottom bg-white">
						<div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
							<div class="bg-me shadow-primary border-radius-lg py-3 pe-1">
								...
								<h1 class="text-white font-weight-bolder text-center mt-2 mb-0"> Pembayran Berhasil </h1>
							</div><br>
							<div align="center" class="card text-white bg-light my-3">
								<?php
								include 'koneksi.php';
								...
								$sql	= "INSERT INTO transaksi VALUES('', '$produk', '$harga', '$metode', '$id_akun', '$game')";
								...
								if ($query) { ?>
									<div class="card-body">
										<?php
										$query2 = mysqli_query($connect, "SELECT * FROM transaksi ORDER BY no_transaksi DESC LIMIT 1");
										$data = mysqli_fetch_array($query2);
										?>
										<div class="table table-responsive bg-light">
							...
							<a class="btn btn-primary w-100" type="button" name="Home" href="index.php">Kemabali</a>
						</div>
					</div>
				</div>
			</div>
