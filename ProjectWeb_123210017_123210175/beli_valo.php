                                ...
                                <div class="container">
                                    <div class="row">
                                        <div class="col-lg-5 my-2">
                                            <img src="./assets/img/valobg.png" alt="" class="img-fluid">
                                            <h2 class="text-white text-black-50">Valorant</h2>
                                            <p class="pe-5">Padukan gaya dan pengalamanmu di panggung kompetitif global. Kamu diberi 13 ronde untuk menyerang dan mempertahankan sisimu dengan keahlian tembak-menembak sengit dan kemampuan taktis. Dengan satu nyawa per ronde, kamu harus berpikir lebih cepat daripada lawan jika ingin tetap hidup. Habisi musuh baik di mode Competitive maupun Tanpa Rank serta Deathmatch dan Spike Rush.</p>
                                            <a href="https://playvalorant.com/id-id/" class="btn btn-link"> -> Baca Lebih Lanjut <- </a>
                                        </div>
                                        <div class="col-lg-7 mt-lg-0 mt-5 ps-lg-0 ps-0">
                                            <div class=" row">
                                                <form action="proses_valo.php" method="POST">
                                                    <div class="card-body bg-white blur-rounded border-radius-xl top-0 z-index-fixed m-2">
                                                        <h5>1. Masukkan Riot ID Anda</h5>
                                                        <div class="row">
                                                            <div class="col-md-6 my-auto">
                                                                ...
                                                                <p class=" text-sm">Contoh Riot ID: RentZ#9901</p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="card-body bg-white blur-rounded border-radius-xl top-0 z-index-fixed m-2">
                                            ...
                                            <input type="text" class="form-control" name="game" value="Valorant" hidden>
                                            <div class="m-2">
